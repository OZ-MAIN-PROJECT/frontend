import { Banknote, ChartPie, House, LogOut, Menu, MessageCircleHeart, MessageCircleMore, Settings, Volume2 } from "lucide-react";
...
const Sidebar = ({ isVisible, toggleSidebar }: { isVisible: boolean, toggleSidebar: () => void }) => {
  return (
    ...
    >
      ...
      <a href="/" className="hidden justify-center lg:flex"><img src={logo} alt="로고" className="w-32 h-auto" /></a>
